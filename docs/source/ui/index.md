...
In here you can find help for the various parts of the Rogallo user
interface.
...
`Change Theme` ([`ChangeTheme`](../configuration/bindings.md#bindable-commands) command, bound to
...
You may also wish to personally customise the look of Rogallo. This can be
done by creating your own [custom themes](./custom-themes.md).
